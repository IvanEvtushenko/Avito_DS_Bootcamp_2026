...
[LEGACY / ABLATION] С введением mini-LTR (`ranking/ltr.py`, план §7.2) ручной
блэнд — не дефолт, а ablation-базлайн (`ranking.method: blend`). Код не удалён:
`stage_blend` сравнивает LR против ручного блэнда по OOF. Оставлено намеренно.
